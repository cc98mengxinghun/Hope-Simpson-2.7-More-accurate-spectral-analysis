...
# Savitzky-Golay
sg_new_confirms = savgol_filter(new_confirms, len(days)-1, 15)
sg_new_death = savgol_filter(new_death, len(days)-1, 15)
...
new_data["new_confirmed_after_sg"] = sg_new_confirms
new_data["total_deaths"] = deaths
new_data["new_deaths"] = new_death
new_data["new_death_after_sg"] = sg_new_death
